...
namespace physics
{
    ...
    {
    public:
        RigidBodyImpl( const JPH::ShapeRefC& shape,
                       u16                   layer,
                       physics::MotionType   motion_type )
        {
            ...
            jph_body_ = physics::Engine::bodyInterface()->CreateBody(
                body_settings );
            ...
            // ワールドに追加 (アクティブ化)
            physics::Engine::bodyInterface()->AddBody(
                jph_body_->GetID(),
        ...
        virtual void setLayer( u16 layer ) override
        {
            physics::Engine::bodyInterface()->SetObjectLayer( body_id_, layer );
        }

        //! オブジェクトレイヤーを取得
        virtual u16 layer() const override
        {
            return physics::Engine::bodyInterface()->GetObjectLayer( body_id_ );
        }
        ...
        virtual void setPosition( const float3& position,
                                  bool          is_activate = true ) override
        {
        ...
        {
            JPH::Vec3 p = physics::Engine::bodyInterface()->GetPosition(
                body_id_ );
            return castJPH( p );
        }
        ...
        {
            JPH::Vec3 p =
                physics::Engine::bodyInterface()->GetCenterOfMassPosition(
                    body_id_ );
            return castJPH( p );
        }
        ...
        {
            JPH::QuatArg q = physics::Engine::bodyInterface()->GetRotation(
                body_id_ );
            return castJPH( q );
        }
        ...
        {
            return castJPH( physics::Engine::bodyInterface()->GetWorldTransform(
                body_id_ ) );
        }
        ...
        {
            return castJPH(
                physics::Engine::bodyInterface()->GetCenterOfMassTransform(
                    body_id_ ) );
        }
        ...
        virtual void moveKinematic( const float3&     target_position,
                                    ...
                                    f32               delta_time ) override
        {
            JPH::Vec3 tpos = castJPH( target_position );
            JPH::Quat trot = castJPH( target_rotation );
            physics::Engine::bodyInterface()->MoveKinematic( body_id_,
                                                             tpos,
                                                             trot,
                                                             delta_time );
        }
        ...
        {
            physics::Engine::bodyInterface()->SetLinearVelocity( body_id_,
                                                                 castJPH( v ) );
        }
        ...
        {
            return castJPH( physics::Engine::bodyInterface()->GetLinearVelocity(
                body_id_ ) );
        }
        ...
        {
            physics::Engine::bodyInterface()->AddLinearVelocity( body_id_,
                                                                 castJPH( v ) );
        }
        ...
        {
            physics::Engine::bodyInterface()->SetAngularVelocity( body_id_,
                                                                  castJPH(
                                                                      vrot ) );
        }
        ...
        {
            return castJPH(
                physics::Engine::bodyInterface()->GetAngularVelocity(
                    body_id_ ) );
        }
        ...
        {
            return castJPH( physics::Engine::bodyInterface()->GetPointVelocity(
                body_id_,
                castJPH( point ) ) );
        }
        ...
        {
            physics::Engine::bodyInterface()->AddForce( body_id_,
                                                        castJPH( force ) );
        }
        ...
        //! @param  [in]    force   与える力
        //! @param  [in]    point   位置
        virtual void addForce( const float3& force,
                               const float3& point ) override
        {
            physics::Engine::bodyInterface()->AddForce( body_id_,
                                                        castJPH( force ),
                                                        castJPH( point ) );
        ...
        {
            physics::Engine::bodyInterface()->AddTorque( body_id_,
                                                         castJPH( torque ) );
        }
        ...
        {
            physics::Engine::bodyInterface()->AddImpulse( body_id_,
                                                          castJPH( impulse ) );
        }
        ...
        {
            physics::Engine::bodyInterface()->AddAngularImpulse(
                body_id_,
                castJPH( impulse ) );
        }
        ...
        //! 跳ね返り係数を取得
        virtual f32 restitution() const override
        {
            return physics::Engine::bodyInterface()->GetRestitution( body_id_ );
        }
        ...
        virtual void setFriction( f32 coeff ) override
        {
            physics::Engine::bodyInterface()->SetFriction( body_id_, coeff );
        }

        //! 摩擦係数を取得
        virtual f32 friction() const override
        {
            return physics::Engine::bodyInterface()->GetFriction( body_id_ );
        }
        ...
        {
            physics::Engine::bodyInterface()->SetGravityFactor( body_id_,
                                                                coeff );
        }

        //! 重力係数を取得
        virtual f32 gravityFactor() const override
        {
            return physics::Engine::bodyInterface()->GetGravityFactor(
                body_id_ );
        }
        ...
        {
            return castJPH( physics::Engine::bodyInterface()->GetInverseInertia(
                body_id_ ) );
        }
        ...
        //! ボディIDを取得
        virtual u64 bodyID() const override
        {
            return body_id_.GetIndexAndSequenceNumber();
        }
    ...
    std::shared_ptr<physics::RigidBody> createRigidBody(
        const shape::Sphere& o, u16 layer, physics::MotionType motion_type )
    {
        // シェイプを生成
        ...
        // 作成
        return std::make_shared<RigidBodyImpl>( result.Get(),
                                                layer,
                                                motion_type );
    }
    ...
    //---------------------------------------------------------------------------
    std::shared_ptr<physics::RigidBody> createRigidBody(
        const shape::Box& o, u16 layer, physics::MotionType motion_type )
    {
        // シェイプを生成
        JPH::BoxShapeSettings shape_settings(
            JPH::Vec3( o.extent_.x, o.extent_.y, o.extent_.z ) );
        JPH::ShapeSettings::ShapeResult result = shape_settings.Create();
    ...
    //---------------------------------------------------------------------------
    std::shared_ptr<physics::RigidBody> createRigidBody(
        const shape::Cylinder& o, u16 layer, physics::MotionType motion_type )
    {
        // シェイプを生成
    ...
    //---------------------------------------------------------------------------
    std::shared_ptr<physics::RigidBody> createRigidBody(
        const shape::ConvexHull& o, u16 layer, physics::MotionType motion_type )
    {
        //----------------------------------------------------------
        // 頂点配列を取得
        //----------------------------------------------------------
                                                         ...
                                                         u16 layer )
    {
        ...
        materialList.push_back( new JPH::PhysicsMaterialSimple(
            "BPMeshMaterial",
            JPH::Color::sGetDistinctColor( 0 ) ) );

        //----------------------------------------------------------
        // シェイプを生成
        //----------------------------------------------------------
        JPH::MeshShapeSettings          shape_settings( vertexList,
                                               indexList,
                                               materialList );
        JPH::ShapeSettings::ShapeResult result = shape_settings.Create();
