...
namespace physics
{
    ...
    public:
        ...
        {
            return physics::Engine::bodyInterface()->GetGravityFactor( body_id_ );
        }
    ...
    std::shared_ptr<physics::RigidBody>
        createRigidBody( const shape::Sphere& o, u16 layer, physics::MotionType motion_type )
    {
        // シェイプを生成
    ...
    //---------------------------------------------------------------------------
    std::shared_ptr<physics::RigidBody>
        createRigidBody( const shape::Box& o, u16 layer, physics::MotionType motion_type )
    {
        // シェイプを生成
    ...
    std::shared_ptr<physics::RigidBody> createRigidBody( const shape::Mesh& o, u16 layer )
    {
        ...
        materialList.push_back(
            new JPH::PhysicsMaterialSimple( "BPMeshMaterial", JPH::Color::sGetDistinctColor( 0 ) ) );
