...
namespace DebugCamera
{
    ...
    public:
        ...
        void PreDraw() override
        {
            ...
            if( control == UnrealEngine )
            {
                ...
                if( M || LR )
                {
                    float3 mv = ( right * -mouse_vec_.x + up * -mouse_vec_.y ) *
                                0.1f;
                ...
                else if( R )
                {
                    ...
                    auto rot_x = matrix::rotateAxis( right,
                                                     -mouse_vec_.y * 0.003f );
                ...
                cam->SetPositionAndTarget( cam_pos_, tgt_pos_ );
                cam->SetCameraStatus( ComponentCamera::CameraBit::DebugCamera,
                                      true );
    ...
    private:
        ...
        {
            arc( CEREAL_NVP( cam_pos_ ),
                 CEREAL_NVP( tgt_pos_ ),
                 CEREAL_NVP( mat_view_ ),
                 CEREAL_NVP( mat_proj_ ) );
