    ...
    void CreateComponent( ObjectPtr obj )
    {
        switch( component_select_index )
        {
            case 0 :
                ...
                break;
            case 1 : obj->AddComponent<ComponentCollisionCapsule>(); break;
            case 2 : obj->AddComponent<ComponentCollisionSphere>(); break;
            case 3 :
...
matrix& Object::Matrix()
{
    ...
    assert( cmp && "このオブジェクトは、ComponentTransformが存在していません。"
                   "位置移動はできません" );
