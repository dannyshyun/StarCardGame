...
void ImGuiInit()
{
    ...
    {
        case DX_DIRECT3D_9 :
        case DX_DIRECT3D_9EX : backend_ = std::make_unique<BackendDX9>(); break;
        case DX_DIRECT3D_11 : backend_ = std::make_unique<BackendDX11>(); break;
        case DX_DIRECT3D_NONE :
        default : throw std::exception( "Can't get DxLib Direct3D Version" );
    }
    // 初期化
    backend_->initialize();
}
