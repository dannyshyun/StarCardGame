...
namespace
{
    constexpr u32 MAX_PAD_NUM = static_cast<u32>(
        PAD_ID::PAD_ID_MAX );  //<! 上下左右/A B C X Y Z L R START Mボタン
    constexpr u32 MAX_PAD_TYPE = static_cast<u32>(
        PAD_NO::PAD_NO_MAX );  //<! PAD接続最大数
    constexpr u32 PAD_BUTTONS[MAX_PAD_NUM] = {
    ...
    constexpr u32 PAD_TYPES[MAX_PAD_TYPE] = {
...
{
    return ( pads_[static_cast<u32>( pad_no )][static_cast<u32>( padID )] ==
             1 );
}
